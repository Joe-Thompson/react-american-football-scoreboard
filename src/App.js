  ...
  return (
    <div className="container">
      <section className="scoreboard">
        <button onClick = {this.toggleDefense} className = "possesion">Change Possesion</button>
        <div className="topRow">
          <div className="home">
            ...
            <p className = {`${defense ? "" : defense}`}><i class="fas fa-football-ball"></i></p>
          </div>
          <div className="timer">00:03</div>
          <div className="away">
            <h2 className="away__name">Tigers</h2>
            <div className="away__score">{awayScore}</div>
            <p className = {`defense ${defense ? "" : defense}`}><i class="fas fa-football-ball"></i></p>
          </div>
        </div>
        <BottomRow />
      </section>
